...
main (int argc, char*argv[])
{
	...
	ros::NodeHandle nh;
	 ...
	 // pcl::io::loadPCDFile ("/Path/TO/ArtificialPointClouds/TwoPlane22.pcd", *cloud);
	  ...
	  pcl::io::loadPCDFile ("/home/benlee/catkin_ws/src/Direct_machining_with_manipulator/test_bed/pcd_data/cluster10.pcd", *cloud);
 ...
 //  writePLY.write ("/Path/TO/RatioSmallestEigen22.ply", *cloud,  false);
  ...
  // writePLY.write ("/Path/TO/EigenTwoPlane90N10.ply", *cloud,  false);
  	...
  	//writePLY.write ("/Path/TO/BunnyEdges.ply", *cloud,  false);
  	 writePLY.write ("//home/benlee/catkin_ws/src/Direct_machining_with_manipulator/test_bed/pcd_data/cluster_edge.ply", *cloud,  false);
