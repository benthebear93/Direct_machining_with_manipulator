...
file_path = '/home/benlee/Desktop/pcd_data/0111pcd'
...
def read_pcd():
	...
	profile_np = np.load(file_path + '/pptk_save_2.npy')
	profile_pcd = pcl.load(file_path + '/pptk_save_2.pcd')
	print("profile_np", profile_np[0])
	print("profile_np", profile_np[1])
	print("profile_np", profile_np[2])
	print("profile_np", profile_np[800])
	#print("read pcd finished")
...
def filter_remove():
	...
	pcl.save(ori_pc,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/ori_cloud.pcd")
	# original 

	pass_filtered_pc = do_pass_through_filtering(ori_pc)       ### works
	pcl.save(pass_filtered_pc,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/pass_filtered.pcd")
	print("passfilter size :", pass_filtered_pc.size)
	#pass through

	voxel_filtered = do_voxel_grid_downsampling(pass_filtered_pc, 0.25) #514,823
	print("voxelfilter size :", voxel_filtered.size)
	pcl.save(voxel_filtered,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/voxel_filtered.pcd")
	# voxel filter

	inlier_pc, outlier_pc =do_statistical_outlier_filter(voxel_filtered, 300, 5)  ##statistical filter 
	inlier_pc100, outlier_pc =do_statistical_outlier_filter(voxel_filtered, 300, 5)  ##statistical filter 
	pcl.save(inlier_pc,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/inlier_pc.pcd")
	pcl.save(inlier_pc100,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/inlier_pc100.pcd")
	# statistical outlier

	smoot_pc = do_smoothing(inlier_pc, 1)
	print("smoothing size :", smoot_pc.size)
	pcl.save(smoot_pc,"/home/benlee/Desktop/pcd_data/0111pcd/save_figure/smoot_pc.pcd")
