...
int main(int argc, char** argv)
{
    ...
    // for (std::vector<descartes_core::TrajectoryPtPtr>::iterator itr = points.begin(); itr != points.end(); ++itr) {
    ...
    pose.translation() = Eigen::Vector3d(path_x, path_y, z_value);
    ...
    int a =0;
    a = model->getAllIK (pose, joint_poses);
    std::cout << "get all ik true: " << a << std::endl;
