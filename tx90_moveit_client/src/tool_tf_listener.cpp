...
int main(int argc, char** argv){
	...
	while (nh.ok()){
	    ...
	    try{
			...
			listener.waitForTransform("world", "camera_depth_frame", now, ros::Duration(3.0));
			listener.lookupTransform("world","camera_depth_frame", ros::Time(0), camera_tf);
	    ...
	    marker.pose.position.x = 0.68017;
	    marker.pose.position.y = 0.03252;
	    marker.pose.position.z = 1.35986 -0.451;
